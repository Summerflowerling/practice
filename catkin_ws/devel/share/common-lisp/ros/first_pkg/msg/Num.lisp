...
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_pkg-msg:num-val is deprecated.  Use first_pkg-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_pkg-msg:first_name-val is deprecated.  Use first_pkg-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_pkg-msg:last_name-val is deprecated.  Use first_pkg-msg:last_name instead.")
  (last_name m))
...
(cl:defmethod score-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_pkg-msg:score-val is deprecated.  Use first_pkg-msg:score instead.")
  (score m))
