...
"""autogenerated by genpy from first_pkg/AddTwoIntsRequest.msg. Do not edit."""
import sys
...
class AddTwoIntsRequest(genpy.Message):
  _md5sum = "f169a2f97ba3cbc67f1025198bb39411"
  _type = "first_pkg/AddTwoIntsRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2q().pack(_x.c, _x.d))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.c, _x.d,) = _get_struct_2q().unpack(str[start:end])
      return self
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from first_pkg/AddTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddTwoIntsResponse(genpy.Message):
  ...
  _type = "first_pkg/AddTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class AddTwoInts(object):
  _type          = 'first_pkg/AddTwoInts'
  _md5sum = 'c3cd2fd36e8ced884a65d3b37b87ebd2'
